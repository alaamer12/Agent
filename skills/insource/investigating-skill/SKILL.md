...
See `references/github-retrieval.md`.
...
See `references/investigation-methodology.md`.
...
See `references/comparison-remixing.md`.
...
- `references/investigation-methodology.md` — detailed analysis framework.
- `references/github-retrieval.md` — raw GitHub retrieval and repository-tree handling.
- `references/comparison-remixing.md` — comparison and Skill-remixing methodology.
- `references/security.md` — external-Skill threat model and safe handling.
