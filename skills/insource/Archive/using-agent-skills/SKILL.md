...
| **audit-deps** | `.cursor/skills/audit-deps/` | Auditing `package.json`, removing unused/redundant deps in monorepo |
...
Task arrives
    ...
    │
    ├── Package audit / cleanup ──────────→ audit-deps
    │
...
| Package Audit / Unused Deps | `audit-deps` |
